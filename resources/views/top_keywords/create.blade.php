...
@section('content')
    <div class="container max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-4">
        <h1 class="text-3xl font-semibold text-gray-800 mb-6">Add New Top Keyword</h1>

        <form action="{{ route('topKeywords.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" name="nombre_requetes" id="nombre_requetes"
                    class="form-control w-full p-3 mt-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                    value="{{ old('nombre_requetes') }}" required min="0">
            ...
            <div class="form-group">
                ...
                @else
                    <select name="id_rapport" id="id_rapport"
                        ...
                        <option value="" disabled selected>Select Rapport</option>
            ...
            <!-- Submit Button -->
            <button type="submit"
                class="w-full py-3 px-6 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300">Save
                Keyword</button>
        </form>
